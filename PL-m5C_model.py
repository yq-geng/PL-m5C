...
class RNASeqClassifier(nn.Module):
    ...
    def __init__(self, num_layers=3, num_heads=4, drop_out=0.2, in_channels=4):
        ...
        self.attention = nn.MultiheadAttention(embed_dim=conv_output_channels[-1], num_heads=num_heads)
    ...
    def forward(self, x):
        ...
        x, _ = self.attention(x, x, x)                      # [batch_size, seq_length, conv_output_dim]
